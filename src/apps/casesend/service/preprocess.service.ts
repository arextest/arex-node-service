...
export class ProprecessService {
  ...
  private urlPretreatment(
    ...
    const pickedEnvList = this.selectEnvList(editorValueMatch, envList);
  ...
  private selectEnvList(
    editorValueMatch: RegExpMatchArray,
    envList: Array<RunEnv>,
  ): Array<RunEnv> {
    const res = new Array<RunEnv>();
